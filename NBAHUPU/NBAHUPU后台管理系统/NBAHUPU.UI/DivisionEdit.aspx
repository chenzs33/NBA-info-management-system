<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DivisionEdit.aspx.cs" Inherits="NBAHUPU.UI.DivisionEdit" %>
    ...
    <div class="list">
        <table class="listtb" style="width: 80%">
            <tr>
                ...
                <td style="width: 30%">
                    <div class="Validform_checktip">*请输入更改后的赛区名称</div>
                </td>
            </tr>
            <tr>
                <th></th>
