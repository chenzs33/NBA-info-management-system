<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="TeamAdd.aspx.cs" Inherits="NBAHUPU.UI.TeamAdd" %>
    ...
    <div class="list">
        <table class="listtb" style="width: 80%">
            <tr>
                <th>球队</th>
                <td style="width: 50%">
                    <asp:TextBox ID="txtTeamName" runat="server" datatype="s" nullmsg="请输入新增球队名称"></asp:TextBox>
                </td>
                <td style="width: 30%">
                    <div class="Validform_checktip">*请输入新增球队名称</div>
                </td>
            </tr>
            <tr>
                <th></th>
